...
},
{
  ...
  "body": " (Gaussian integers as a quotient ring)  We show that . Consider the map defined by Check that the map is a ring epimorphism. We compute its kernel, . The ideal generated by , . Now suppose that . Since the is invertible in , we use , to obtain with such that . Hence, If then , by , for some . This implies that , a contradiction. Hence and . Therefore, and by , we get the result.  "
},
{
...
},
{
  "id": "p-103",
  "level": "2",
  "url": "sec-min-poly-of-linear-map.html#p-103",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
